...
const HomeSection = () => {
  return (
      <section id="home" className="grid gap-8 md:grid-cols-2">
        ...
        <div className="mt-[100px] mx-[10px] text-[62px] font-medium mb-[20px] text-lef md:ml-[200px] md:pt-[100px]">Does your pet need care while you are away?</div>
        <div className="mx-[10px] text-[40px] mb-[20px] text-left md:col-span-2  md:pl-[200px] md:w-1/2">We offer various care options for your pupil.</div>
