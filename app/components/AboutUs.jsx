...
const AboutUs = () => {
  return (
    <div name="about-us" classNameName="w-full h-screen">
      <div classNameName="grid h-screen place-items-center mx-auto w-full">
        <div classNameName="  lg:mt-[100px] lg:grid xl:grid-cols-4 lg:grid-cols-2 block gap-0 mx-[15%] lg:mx-[50px] w-[95%] sm:w-[90%] xl:w-[90%] 2xl:w-[85%]">
          <div classNameName="grid content-center lg:col-span-1 xl:col-span-2 lg:max-w-[840px] w-full lg:mr-8">
            <div classNameName="grid w-full items-center  text-3xl lg:text-6xl xl:text-7xl font-medium grow ">
              <div classNameName="md:mt-[-50px] md:flex-col md:w-[80%] md:mx-auto">
                <h1 classNameName="text-[40px] font-medium border-b-[4px] border-[#04A777] text-left w-[180px] lg:mt-[-150px] lg:ml-[-30px] md:ml-[-30px] md:mt-10px mt-20">
                  About Us
                </h1>
              </div>
              <Image
          ...
          <Image
            ...
            classNameName="lg:hidden block mx-auto mt-[10px] sm"
          />
        </div>
      </div>
    </div>
