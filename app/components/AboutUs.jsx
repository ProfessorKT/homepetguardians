      ...
      <div className="grid h-screen place-items-center mx-auto w-full">
        <div className="  lg:mt-[100px] lg:grid xl:grid-cols-4 lg:grid-cols-2 block gap-0 mx-[15%] lg:mx-[50px] w-[95%] sm:w-[90%] xl:w-[90%] 2xl:w-[85%]">
          ...
          <div class="lg:flex lg:place-content-end mt-10 lg:mt-0 lg:text-[24px] lg:text-right xl:col-span-2 sm:text-left">
            <div>
              <span class="sm:text-[24px] md:text-[32px]  font-bold text-black">
                Welcome to
              </span>
              <span class=" sm:text-[24px] md:text-[32px]  font-bold text-[#04A777]">
                HomePetGuardians
              </span>
              ,<br class="sm:mt-0"></br>
              <span class=" sm:text-[14px] md:text-[20px] lg:text-[24px]">
              ...
              <span class=" sm:text-[14px] md:text-[20px] lg:text-[24px]">
                At{" "}
                <span class="font-bold text-[#04A777]">HomePetGuardians</span>,
                we take pride in our team of dedicated caregivers who understand
