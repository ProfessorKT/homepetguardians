      ...
      <div className="pt-[100px] text-center">
        ...
        <form action="" className="flex flex-col w-[688px] mx-auto">
          <input
            ...
            id="name"
            placeholder="Name"
            className="md:mt-10 mt-16 py-3 px-3 font-light border-2 border-[#04A777] rounded-lg md:text-[24px]
          ...
          <input
            ...
            className="mt-8 py-3 px-3 font-light border-2 border-[#04A777] rounded-lg md:text-[24px]
            text-[18px] placeholder-black focus:outline-none focus:box-shadow-none"
          />
